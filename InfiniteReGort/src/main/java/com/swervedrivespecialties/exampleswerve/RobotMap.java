...
public class RobotMap {
    ...
    public static final int DRIVETRAIN_FRONT_LEFT_DRIVE_MOTOR = 0; // PWM
    ...
    public static final int DRIVETRAIN_FRONT_RIGHT_DRIVE_MOTOR = 1; // PWM

    public static final int DRIVETRAIN_BACK_LEFT_ANGLE_MOTOR = 3; // CAN
    public static final int DRIVETRAIN_BACK_LEFT_ANGLE_ENCODER = 2; // Analog
    public static final int DRIVETRAIN_BACK_LEFT_DRIVE_MOTOR = 2; // PWM
    ...
    public static final int DRIVETRAIN_BACK_RIGHT_DRIVE_MOTOR = 3; // PWM
}
